...
const CARD_DECK = [
  {
    title: '云隙',
    keyword: '先松一口气',
    mantra: '今天先别急着把所有事想明白。能把心里绷着的那一下放松一点，就已经很好了。',
    action: '给自己留十分钟，不处理问题，只做一件能让你慢下来的小事。',
    accent: 'linear-gradient(180deg, rgba(255,255,255,0.96) 0%, rgba(245,236,228,0.98) 100%)',
  },
  {
    title: '向光',
    keyword: '先看清这一点',
    mantra: '你现在这么累，不是因为你不行，而是这段时间真的撑得太久了。',
    action: '写下今天最耗你的那件事，别急着评价自己，先把事和人分开。',
    accent: 'linear-gradient(180deg, rgba(255,247,236,0.98) 0%, rgba(248,227,205,0.98) 100%)',
  },
  {
    title: '落枝',
    keyword: '放下一点点',
    mantra: '有些委屈会一直留着，不是因为你放不下，只是你总把它咽回去了。',
    action: '把那句一直没说出口的话写下来，不用发出去，先让它从心里出来。',
    accent: 'linear-gradient(180deg, rgba(255,250,247,0.98) 0%, rgba(239,225,218,0.98) 100%)',
  },
  {
    title: '回声',
    keyword: '先被接住',
    mantra: '有些情绪不用急着处理。先有人陪着，很多时候就已经不一样了。',
    action: '今晚睡前，留一句轻一点的话给自己，就像你会安慰别人那样。',
    accent: 'linear-gradient(180deg, rgba(254,247,242,0.98) 0%, rgba(242,232,225,0.98) 100%)',
  },
  {
    title: '薄雾',
    keyword: '别一下想太多',
    mantra: '你现在脑子里这团东西有点挤。先理清一小块，比逼自己全想明白更有用。',
    action: '把你最担心的三件事写下来，只留今天真的要处理的一件。',
    accent: 'linear-gradient(180deg, rgba(252,247,244,0.98) 0%, rgba(239,231,226,0.98) 100%)',
  },
  {
    title: '停泊',
    keyword: '先靠一下岸',
    mantra: '你不用一直顶着。人累的时候，先停一会儿，比硬撑下去更实际。',
    action: '去接杯水，或者站起来走两分钟，让身体先从紧绷里退一点出来。',
    accent: 'linear-gradient(180deg, rgba(255,249,244,0.98) 0%, rgba(242,234,226,0.98) 100%)',
  },
  {
    title: '旧信',
    keyword: '别急着下结论',
    mantra: '你现在对自己的评价，可能带着今天的情绪。晚一点再下定论，会更准一点。',
    action: '把刚才脑子里那句最重的话改写一遍，换成更接近事实的说法。',
    accent: 'linear-gradient(180deg, rgba(254,248,242,0.98) 0%, rgba(244,233,224,0.98) 100%)',
  },
  {
    title: '微光',
    keyword: '先顾眼前',
    mantra: '不用一口气把整段路都想完。眼前这一步能踩稳，已经很重要了。',
    action: '问自己一句：如果只处理接下来一小时，我最想先做什么？',
    accent: 'linear-gradient(180deg, rgba(255,246,238,0.98) 0%, rgba(247,230,214,0.98) 100%)',
  },
  {
    title: '缓坡',
    keyword: '慢一点也行',
    mantra: '你最近可能一直在催自己快点好起来。可有些状态，本来就只能一点点退。',
    action: '今天把标准降一点，给自己留一件“做到七分就可以”的事。',
    accent: 'linear-gradient(180deg, rgba(252,246,241,0.98) 0%, rgba(238,229,220,0.98) 100%)',
  },
  {
    title: '折页',
    keyword: '先翻过这一页',
    mantra: '不是所有情绪都得聊很深。有时候先把这一页轻轻翻过去，也是在照顾自己。',
    action: '今晚给自己安排一个明确的结束动作，比如洗澡、关灯、放下手机。',
    accent: 'linear-gradient(180deg, rgba(255,248,245,0.98) 0%, rgba(241,230,223,0.98) 100%)',
  },
  {
    title: '松针',
    keyword: '别总往心里收',
    mantra: '你可能已经很习惯说“没事”。但有些事不是没事，只是你不想麻烦别人。',
    action: '试着给一个信任的人发一句很短的话：我今天有点累，想找你说两句。',
    accent: 'linear-gradient(180deg, rgba(250,247,242,0.98) 0%, rgba(235,229,220,0.98) 100%)',
  },
  {
    title: '晚风',
    keyword: '让今天轻一点',
    mantra: '今天如果已经够难了，就先别要求自己还要表现得很好。',
    action: '睡前把明天最担心的一件事写下来，然后告诉自己：明天再处理。',
    accent: 'linear-gradient(180deg, rgba(254,248,244,0.98) 0%, rgba(240,231,225,0.98) 100%)',
  },
  {
    title: '空杯',
    keyword: '你也需要被照顾',
    mantra: '你一直在顾很多事，也难怪会觉得空。不是你扛不住，是你已经消耗太久了。',
    action: '今天先补一件最基础的事：吃点东西、喝水、早点躺下，选一个就行。',
    accent: 'linear-gradient(180deg, rgba(255,249,246,0.98) 0%, rgba(243,233,226,0.98) 100%)',
  },
  {
    title: '余温',
    keyword: '留一点缓冲',
    mantra: '你不必每次都立刻整理好自己。留一点乱，也不代表你就失控了。',
    action: '给接下来的安排腾出十分钟空白，不聊天、不刷消息，什么都不急着做。',
